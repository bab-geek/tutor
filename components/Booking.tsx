  ...
  if (bookingStatus === 'success') {
    return (
      <div className="max-w-3xl mx-auto py-12 px-4 sm:px-6 lg:px-8 text-center bg-white rounded-lg shadow-lg border border-slate-100 mt-10">
        ...
        <h2 className="mt-4 text-3xl font-extrabold text-brand-primary">Request Received!</h2>
        <p className="mt-2 text-lg text-slate-500">
          Thank you. Prof Alexander has received your booking request. He will contact you shortly on WhatsApp to confirm the location and session details.
        </p>
        <button 
        ...
        <div className="mt-10 lg:mt-0 bg-white shadow-xl rounded-xl p-8 border border-slate-200">
          ...
          <form onSubmit={handleBooking} className="space-y-6">
            <div>
              ...
              <input type="text" required id="name" className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-brand-primary focus:ring-brand-primary sm:text-sm p-3 border bg-slate-50" placeholder="e.g. John Doe" />
            </div>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
               <div>
                  <label htmlFor="phone" className="block text-sm font-medium text-slate-700">Phone Number</label>
                  <input type="tel" required id="phone" className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-brand-primary focus:ring-brand-primary sm:text-sm p-3 border bg-slate-50" placeholder="07XX XXX XXX" />
               </div>
               <div>
                  <label htmlFor="subject" className="block text-sm font-medium text-slate-700">Level & Subject</label>
                  <select id="subject" className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-brand-primary focus:ring-brand-primary sm:text-sm p-3 border bg-slate-50">
                      <optgroup label="IGCSE">
                        <option>IGCSE Mathematics</option>
                        <option>IGCSE Physics</option>
                        <option>IGCSE Both</option>
                      </optgroup>
                      <optgroup label="A Level / IB">
                        <option>A Level Mathematics</option>
                        <option>A Level Physics</option>
                        <option>IB Mathematics</option>
            ...
            <div>
              ...
              <div className="mt-1 relative rounded-md shadow-sm">
                 ...
                 <input type="text" required id="location" className="focus:ring-brand-primary focus:border-brand-primary block w-full pl-10 sm:text-sm border-gray-300 rounded-md p-3 border bg-slate-50" placeholder="e.g. Westlands, Parklands, Nyali" />
              </div>
              <p className="mt-1 text-xs text-slate-500 italic">Prof Alexander will use this to plan the commute.</p>
            </div>
            ...
            <div>
               ...
               <div className="mt-1 grid grid-cols-2 gap-4">
                   <div className="relative rounded-md shadow-sm">
                       ...
                       <input type="date" required className="focus:ring-brand-primary focus:border-brand-primary block w-full pl-10 sm:text-sm border-gray-300 rounded-md p-3 border bg-slate-50" />
                   </div>
                   <div className="relative rounded-md shadow-sm">
                       <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                           <Clock className="h-5 w-5 text-gray-400" />
                       </div>
                       <select className="focus:ring-brand-primary focus:border-brand-primary block w-full pl-10 sm:text-sm border-gray-300 rounded-md p-3 border bg-slate-50">
               ...
               <div className="flex">
                  ...
                  <div className="ml-3">
                     ...
                     <div className="mt-2 text-sm text-slate-600">
                        <p>Rates are discussed and agreed upon based on location, level (IGCSE/IB/A-Level), and hours.</p>
                     </div>
                  </div>
               </div>
            </div>
            ...
            <button
              ...
              className="w-full flex justify-center py-3 px-4 border border-transparent rounded-md shadow-sm text-sm font-bold text-white bg-brand-primary hover:bg-brand-dark focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-brand-primary disabled:opacity-50 transition-colors"
            >
