      ...
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row justify-between gap-8 text-center md:text-left">
          ...
          <div className="flex flex-col items-center md:items-start flex-1">
            <h3 className="text-white text-lg font-bold mb-4">Nairobi IGCSE Tutor</h3>
            <p className="text-sm max-w-xs leading-relaxed">
              Mr. Kuloba Alex provides expert IGCSE Mathematics and Physics tuition at the comfort of your home.
            </p>
          </div>
